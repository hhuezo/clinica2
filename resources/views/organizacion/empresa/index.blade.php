...
@section('content')
        ...
        <div class="col-xl-12">
            <div class="card custom-card">
                <div class="card-header justify-content-between">
                    <div class="card-title mb-0">Listado de empresas</div>
                        ...
                        <table id="datatable-basic" class="table table-striped text-nowrap w-100">
                            ...
                            <tbody>
                                @foreach ($empresas as $item)
                                    ...
                                    @can('empresas.gestionar')
                                        @include('organizacion.empresa.edit')
                                        @include('organizacion.empresa.delete')
                                    @endcan
                                @endforeach
                            </tbody>
                        </table>
    ...
    @can('empresas.gestionar')
        <div class="offcanvas offcanvas-end" tabindex="-1" id="drawer-create">
            <div class="offcanvas-header border-bottom">
                <h6 class="offcanvas-title">Crear empresa</h6>
                <button type="button" class="btn-close" data-bs-dismiss="offcanvas"></button>
            </div>
            <form method="POST" action="{{ route('organizacion.empresas.store') }}">
                @csrf
    ...
    <script>initDataTable('#datatable-basic', 'organizacionMenu', 'empresasOption');</script>
@endsection
