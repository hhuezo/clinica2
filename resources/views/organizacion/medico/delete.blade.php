...
<div class="offcanvas-header border-bottom">
    <h6 class="offcanvas-title">Eliminar médico</h6>
    <button type="button" class="btn-close" data-bs-dismiss="offcanvas"></button>
</div>
<div class="offcanvas-body">
    <p>¿Eliminar al médico <strong>{{ $item->nombre_completo }}</strong>?</p>
</div>
<div class="border-top p-3 d-flex justify-content-end gap-2">
    ...
    <form method="POST" action="{{ route('organizacion.medicos.destroy', $item) }}">
    @csrf @method('DELETE')
